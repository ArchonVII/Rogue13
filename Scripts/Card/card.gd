...
@export var angle_x_max: float = 3.0
@export var angle_y_max: float = 3.0
@export var max_offset_shadow: float = 10.0

@export_category("Oscillator")
@export var spring: float = 150.0
@export var damp: float = 10.0
@export var velocity_multiplier: float = 1.1
...
func rotate_velocity(delta: float) -> void:
	...
	velocity = ((position - last_pos) / delta)/ 2
	last_pos = position
